...
srcdir = ext
topdir = /Users/yanovich/.rvm/rubies/ruby-1.9.3-p484/include/ruby-1.9.1
hdrdir = /Users/yanovich/.rvm/rubies/ruby-1.9.3-p484/include/ruby-1.9.1
arch_hdrdir = /Users/yanovich/.rvm/rubies/ruby-1.9.3-p484/include/ruby-1.9.1/$(arch)
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/yanovich/.rvm/rubies/ruby-1.9.3-p484
...
sitearch = $(arch)
ruby_version = 1.9.1
ruby = /Users/yanovich/.rvm/rubies/ruby-1.9.3-p484/bin/ruby
RUBY = $(ruby)
RM = rm -f
...
SRCS = consistent.c
OBJS = consistent.o
TARGET = consistent_ring
TARGET_NAME = consistent_ring
...
pre-install-rb-default:
	$(ECHO) installing default consistent_ring libraries
./.RUBYARCHDIR.time:
